...
const counsellorAuth = (req,res)=>{
    ...
    if(!token){
        return res.json({success:false,message:`Councellor is Not Authorized, Login Again Please`});
    }
...
export { setUserTokenAndCookie,userAuth, setCounsellorTokenAndCookies, counsellorAuth};